...
/// interactive guide for using chizu
#[derive(FromArgs, Debug)]
...
/// initialize a new .chizu.toml config file
#[derive(FromArgs, Debug)]
#[argh(subcommand, name = "init")]
pub struct ConfigInitCmd {
    /// path to create config (default: <repo>/.chizu.toml)
    #[argh(option)]
...
/// validate existing .chizu.toml config file
#[derive(FromArgs, Debug)]
