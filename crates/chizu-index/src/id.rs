...
mod tests {
    ...
    fn id_formats() {
        ...
        assert_eq!(
            symbol_id("chizu-core", "Store"),
            "symbol::chizu-core::Store"
        );
        assert_eq!(
            test_id("chizu-core", "test_foo"),
            "test::chizu-core::test_foo"
        );
        assert_eq!(
            bench_id("chizu-core", "bench_bar"),
            "bench::chizu-core::bench_bar"
        );
        assert_eq!(
            feature_id("chizu-core", "default"),
            "feature::chizu-core::default"
        );
        assert_eq!(
            doc_id("chizu-core", "README.md"),
            "doc::chizu-core::README.md"
        );
